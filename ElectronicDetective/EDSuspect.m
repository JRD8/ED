...
- (NSString *)description
{
    ...
    return [NSString stringWithFormat:@"Suspect Number: %d, Suspect Type = %d, Name = %@, Occupation = %@, Marital Status = %@, Suspect Location = %d, Private Question List = %@, Victim = %@, Murderer = %@, Assigned Yet = %@", suspectNumber, suspectType, suspectName, suspectOccupation, suspectMaritalStatus, suspectLocation, privateQuestionForDescription, victim ? @"YES" : @"NO", murderer ? @"YES" : @"NO", assignedYet ? @"YES" : @"NO"];
}
